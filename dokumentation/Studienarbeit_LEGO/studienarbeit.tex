...
\begin{document}
	...
	\section{Projektziel}
	Das Ziel des Lego Racers Projekts ist es, mithilfe von LEGO Mindstorm Bausteinen autonom fahrende Rennwagen zu realisieren. Diese sollen eine vorgegebene Strecke in möglichst kurzer Zeit befahren. Darüber hinaus wird angestrebt, eine Strecke mit mehreren Fahrzeugen kollisionsfrei zu durchfahren. Als mögliche Erweiterung wird die Steuerung der Fahrzeuge per Smartphone-App angedacht, um verschiedene Modi zu ermöglichen. Ziel ist zunächst der Bau eines Fahrzeuges, das auf optimales Befahren der Strecke ausgelegt ist. Erweiternd soll das Projekt um weitere Fahrzeuge ergänzt werden, die die Funktionalitäten des Prototyps übernehmen und zusätzlich Kollisionsvermeidung ermöglichen sollen.
	...
	\newpage
	\subsection{Fahrzeuganforderungen}\label{fahrzeugAnf}
		\begin{figure}[h]
	...
	\bigskip
	Die meisten Farben lassen sich laut Testreihe relativ gut unterscheiden. Lediglich der Unterschied zwischen gelb und weiß (in dem Fall Kreppband) ist sehr gering. Deshalb werden gelbe Linien nicht verwendet (siehe Kapitel~\ref{strecke}).
	...
	\bigskip
	Die genaue Verteilung der Sensoren auf dem Fahrzeug (siehe Kapitel~\ref{fahrzeugAnf}) wird aktuell diskutiert. Unter anderem steht die Frage der Verwendung eines Multiplexers im Raum, um so mehr Sensoren an den NXT anschließen und in der Software verwenden zu können. 
	...
	Als Fahrbahn dient eine speziell zugeschnittene schwarze Klebe-Folie. Dabei wurde zunächst der maximale Einschlagwinkel des Fahrzeugs ermittelt und darauf basierend die Kurven vorgezeichnet. Anschließend wurden die Streckenabschnitte in Geraden und Kurven unterteilt und die jeweiligen Abschnitte aus der Folie ausgeschnitten. Die Form der Rennbahn orientiert sich an den Streckenüberlegungen aus Kap.~\ref{strecke}. Es liegen sowohl Rechts-, als auch Linkskurven vor, die alle unterschiedliche Kurvenwinkel aufweisen.
	\smallskip
	...
	Zur Erkennung der Übergänge zwischen Kurven und Geraden dienen grüne Pappstreifen von 1cm Breite. Die Startlinie markiert ein roter Streifen Pappe. 
